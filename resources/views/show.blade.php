<x-app-layout>
	...
	<div class="container mx-auto px-4">
		...
		<section class="game-details border-b border-gray-800 pb-12 flex flex-col md:flex-row md:space-x-8 lg:space-x-10">
			...
			<div>
				...
				<h2 class="font-semibold text-4xl leading-tight mt-5 md:mt-0">Name of the Game</h2>
				...
				<div class="flex flex-wrap items-center mt-8">
					...
					<div class="flex items-center space-x-4">
						...
						<div class="text-xs">Member <br> Score</div>
					</div>
					...
					<div class="flex items-center space-x-4 ml-12">
						...
						<div class="text-xs">Critic <br> Score</div>
					</div>
					
					<div class="flex items-center space-x-4 mt-4 ml-1 lg:mt-0 lg:ml-12">
				...
				<p class="mt-12 lg:mr-64">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias aliquid animi asperiores blanditiis
					consequatur deserunt dolor doloribus esse expedita facilis hic illum ipsa iusto labore libero, minus
					necessitatibus nisi odio officia omnis quibusdam quidem saepe similique sit ut voluptate voluptatum.
					Aperiam blanditiis, corporis dolores est eum facilis illum possimus sed!
				</p>
		...
		</section> {{-- End Games Details--}}
		
		<section class="images-container border-b border-gray-800 pb-12 mt-8">
		...
		<section class="similar-games-container mt-8">
			
			<h2 class="text-blue-500 uppercase tracking-wide font-semibold">Similar Games</h2>
			
		</section> {{-- End Similar Games Container--}}
